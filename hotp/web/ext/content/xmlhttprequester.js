function moodleotp_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
moodleotp_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				moodleotp_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
moodleotp_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
moodleotp_xmlhttpRequester.prototype.setupRequestEvent =
